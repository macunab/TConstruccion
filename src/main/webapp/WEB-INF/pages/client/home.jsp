...
<body>
	...
	<div id="main-body">
		<div id="carousel_container">
			<div id="ca" class="container hidden-xs">
				<div class="slideshow">
					<div id="slideshow" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner">
							<div class="item active">
								<div class="row">
									...
									<c:forEach items="${carousel1 }" var="producto">
										<div class="te col-sm-3">
											<a href="#" class="thumbnail"> <img
												src="resources/img/martill01000.jpg" alt="Image"
												style="max-width: 100%;" />
												<button type="button"
													class="btn btn-warning btn-item-carousel"
													style="display: none;" onClick="">Agregar</button>
											</a>
							...
							<div class="item">
								<div class="row">
									...
									<c:forEach items="${carousel2 }" var="producto">
										<div class="te col-sm-3">
											<a href="#" class="thumbnail"> <img
												src="resources/img/martill01000.jpg" alt="Image"
												style="max-width: 100%;" />
							...
							<div class="item">
								<div class="row">
									...
									<c:forEach items="${carousel3 }" var="producto">
										<div class="te col-sm-3">
											<a href="#" class="thumbnail"> <img
												src="resources/img/martill01000.jpg" alt="Image"
												style="max-width: 100%;" />
						...
						<div class="controlsBlock">
							<div class="controls">
								<a class="left carousel-control" href="#slideshow"
							...
							<div id="myTab" class="pull-right">
								<a href="#listView" data-toggle="tab"><span
									class="btn btn-large"><i
										class="glyphicon glyphicon-list"></i></span></a> <a href="#blockView"
